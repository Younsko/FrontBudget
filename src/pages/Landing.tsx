...
{/* New Full Green Footer Section */}
<footer className="bg-primary text-white px-4 py-20 mt-16">
    ...
    {!isAuthenticated ? (
      <Link to="/register" className="inline-block">
        <Button
          size="lg"
          variant="secondary"
          className="bg-white text-primary-dark hover:bg-white/90 flex items-center justify-center gap-2 mx-auto"
        >
          Get Started Free
